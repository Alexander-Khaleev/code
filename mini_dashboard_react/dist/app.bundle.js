...
var _Add = __webpack_require__(29);
				...
				_createClass(App, [{
								...
								value: function render() {
												return _react2.default.createElement(
																...
																_react2.default.createElement(_Show2.default, { workers: workers })
												);
								}
				}]);
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					' ',
					_react2.default.createElement('input', { type: 'text', placeholder: '\u0418\u043C\u044F' })
				),
				_react2.default.createElement(
					'div',
					{ className: 'col-xs-12 col-sm-6 col-md-2 col-lg-2' },
					' ',
					_react2.default.createElement('input', { type: 'text', placeholder: '\u0424\u0430\u043C\u0438\u043B\u0438\u044F' })
				),
				_react2.default.createElement(
					'div',
					{ className: 'col-xs-12 col-sm-6 col-md-2 col-lg-2' },
					' ',
					_react2.default.createElement('input', { type: 'text', placeholder: '\u041E\u0442\u0447\u0435\u0441\u0442\u0432\u043E' })
				),
				_react2.default.createElement(
					'div',
					{ className: 'col-xs-12 col-sm-6 col-md-2 col-lg-2' },
					' ',
					_react2.default.createElement('input', { type: 'text', placeholder: '\u0414\u043E\u043B\u0436\u043D\u043E\u0441\u0442\u044C' })
				),
				_react2.default.createElement(
					'div',
...
var Show = function (_Component) {
	...
	_createClass(Show, [{
		key: 'render',
		value: function render() {
			var personal = this.props.workers.map(function (worker) {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_Card2.default, { name: worker.name, surname: worker.surname, patronym: worker.patronym, position: worker.position })
				);
			});
			return _react2.default.createElement(
				'div',
